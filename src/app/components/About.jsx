    ...
    return (
        <div className='about h-[100vh] w-[90%] flex flex-col align-center text-center md:text-left'>
            ...
            <div className="h-[40%] md:h-[60%] md:inline-grid md:grid-cols-2 md:grid-rows-1 md:gap-4">
                <Spline className="" scene="https://prod.spline.design/0A-9m2vfBHBrKlWe/scene.splinecode" />
                <div className='flex flex-col justify-center align-left pr-10'>
                    <p className="text-white text-center md:text-justify text-xl md:text-2xl p-4 md:p-0 "> {text.about}</p>
